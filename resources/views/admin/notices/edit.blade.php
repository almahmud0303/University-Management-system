<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.notices.show', $notice->id) }}" class="text-blue-600 hover:text-blue-800">
                ← Back to Notice
            </a>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('admin.notices.update', $notice->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', $notice->expiry_date ? $notice->expiry_date->format('Y-m-d') : '') }}" 
