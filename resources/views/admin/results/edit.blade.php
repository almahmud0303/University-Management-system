                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600">Student: {{ $result->student->user->name }} | Exam: {{ $result->exam->title }}</p>
                        </div>
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.results.show', $result) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                                View Result
                            </a>
                    ...
                    <form method="POST" action="{{ route('admin.results.update', $result) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="marks_obtained" id="marks_obtained" step="0.01" min="0" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('marks_obtained') border-red-300 @enderror" value="{{ old('marks_obtained', $result->marks_obtained) }}">
                            ...
                            <div>
                                ...
                                <textarea name="remarks" id="remarks" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('remarks') border-red-300 @enderror">{{ old('remarks', $result->remarks) }}</textarea>
                                @error('remarks')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_published" id="is_published" value="1" {{ old('is_published', $result->is_published) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('admin.results.show', $result) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md text-sm font-medium">
                                Cancel
                            </a>
