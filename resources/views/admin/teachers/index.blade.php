                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($teachers as $teacher)
                                        <tr>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <div class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                                                            <span class="text-sm font-medium text-gray-700">{{ substr($teacher->user->name, 0, 1) }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $teacher->department->name ?? 'N/A' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $teacher->user->email }}</td>
