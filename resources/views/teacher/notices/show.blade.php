            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('teacher.notices.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                            Back to Notices
                        </a>
                    </div>
                </div>
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                            {{ $notice->target_role == 'all' ? 'bg-purple-100 text-purple-800' : 
                               ($notice->target_role == 'teacher' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800') }}">
